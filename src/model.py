...
def calculate_processability(input_data: TopographyInput) -> ProcessabilityResult:
    ...
    try:
        if input_data.curvature_radius <= 0:
            raise ValueError("Curvature radius must be greater than 0.")
        ...
        # Strain is inversely proportional to the curvature radius.
        strain = 1.0 / input_data.curvature_radius
